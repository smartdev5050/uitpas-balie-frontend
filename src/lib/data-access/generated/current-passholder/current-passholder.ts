...
export const getUitidPassholderRegistrationToken = (
  ...
  return axios.get(`/passholders/me/uitid/registration-token`, options);
};
...
export const getUitidPassholderStatus = (
  ...
  return axios.get(`/passholders/me/uitid/status`, options);
};
...
export const registerUitidPassholder = (
  ...
  return axios.put(`/passholders/me/uitid`, undefined, options);
};
...
export const getPassholdersMe = (
  ...
  return axios.get(`/passholders/me`, options);
};
...
export const postPassholdersMe = (
  ...
  return axios.post(`/passholders/me`, passholderSelfRegistration, options);
};
...
export const postPassholdersMeCheckin = (
  postPassholdersMeCheckinBody: PostPassholdersMeCheckinBody,
  options?: AxiosRequestConfig
...
export type PostPassholdersMeCheckinMutationResult = NonNullable<
  Awaited<ReturnType<typeof postPassholdersMeCheckin>>
>;
export type PostPassholdersMeCheckinMutationBody = PostPassholdersMeCheckinBody;
export type PostPassholdersMeCheckinMutationError = AxiosError<
  Error | UnauthorizedResponse | ForbiddenResponse
>;

export const usePostPassholdersMeCheckin = <
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>,
  TContext = unknown
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof postPassholdersMeCheckin>>,
    TError,
    { data: PostPassholdersMeCheckinBody },
    TContext
  >;
  axios?: AxiosRequestConfig;
}) => {
...
export const getPassholdersMeTransactions = (
  params?: GetPassholdersMeTransactionsParams,
  options?: AxiosRequestConfig
): Promise<AxiosResponse<TransactionsPaginatedCollection>> => {
  return axios.get(`/passholders/me/transactions`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};

export const getGetPassholdersMeTransactionsQueryKey = (
  params?: GetPassholdersMeTransactionsParams
) => [`/passholders/me/transactions`, ...(params ? [params] : [])];

export type GetPassholdersMeTransactionsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getPassholdersMeTransactions>>
>;
export type GetPassholdersMeTransactionsQueryError = AxiosError<
  Error | UnauthorizedResponse | ForbiddenResponse
>;

export const useGetPassholdersMeTransactions = <
  TData = Awaited<ReturnType<typeof getPassholdersMeTransactions>>,
  TError = AxiosError<Error | UnauthorizedResponse | ForbiddenResponse>
>(
  params?: GetPassholdersMeTransactionsParams,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetPassholdersMeTransactionsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getPassholdersMeTransactions>>
  > = ({ signal }) =>
    getPassholdersMeTransactions(params, { signal, ...axiosOptions });
