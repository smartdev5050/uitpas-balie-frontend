...
export type GetRewardsParams = { start?: StartParameter; limit?: LimitParameter; organizerId?: string[]; organizerPostalCode?: string[]; owningCardSystemId?: string[]; applicableCardSystemId?: string[]; type?: GetRewardsType; text?: string; facets?: GetRewardsFacetsItem[]; sort?: string; 'sort[name]'?: GetRewardsSortName; 'sort[creationDate]'?: GetRewardsSortCreationDate; 'sort[redeemCount]'?: GetRewardsSortRedeemCount; 'sort[featured]'?: GetRewardsSortFeatured; 'sort[points]'?: GetRewardsSortPoints; categories?: GetRewardsCategoriesItem[]; pointsFrom?: number; pointsTo?: number; subset?: GetRewardsSubset; sport?: boolean; forKids?: boolean; featured?: boolean; online?: boolean; lastChance?: boolean; status?: GetRewardsStatus; isRedeemableByPassholderId?: string; isInterestingForPassholderId?: string };
