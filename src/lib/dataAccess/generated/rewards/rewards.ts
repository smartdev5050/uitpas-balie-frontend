...
>;
export type GetRewardsQueryError = AxiosError<
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getRewards>>> = ({
    signal,
  }) => getRewards(params, { signal, ...axiosOptions });
...
export const postRewards = (
  ...
  return axios.post(`/rewards`, reward, options);
};
...
export const getRewardsId = (
  ...
  return axios.get(`/rewards/${rewardId}`, options);
};
...
export const putRewardsId = (
  ...
  return axios.put(`/rewards/${rewardId}`, reward, options);
};
...
export const getRewardsIdRedeemStatus = (
  ...
  return axios.get(`/rewards/${rewardId}/redeem-status`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
...
export const getGetRewardsIdRedeemStatusQueryKey = (
  rewardId: string,
  params: GetRewardsIdRedeemStatusParams
) => [`/rewards/${rewardId}/redeem-status`, ...(params ? [params] : [])];
...
export const postRewardsRedeemed = (
  ...
  return axios.post(`/rewards/redeemed`, postRewardsRedeemedBody, options);
};
...
export const getGetRewardsRedeemedQueryKey = (
  params: GetRewardsRedeemedParams
) => [`/rewards/redeemed`, ...(params ? [params] : [])];
